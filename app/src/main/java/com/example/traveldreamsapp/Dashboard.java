...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard); // Asegúrate de que este es el layout de tu Dashboard

        // Ajuste de insets para barras del sistema
        // Asegúrate de que el LinearLayout principal en activity_dashboard.xml tenga android:id="@+id/main"
